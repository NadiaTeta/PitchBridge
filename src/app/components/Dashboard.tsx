...
export function Dashboard() {
  ...
  const userProjects = user.role === 'entrepreneur'
    ? mockProjects.filter((p) => p.entrepreneur === 'Jean-Claude Mugabo')
    : [];
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
              ...
              <div className="bg-slate-900 rounded-[1.5rem] md:rounded-[2rem] p-6 md:p-8 shadow-sm text-white">
                ...
                <p className="text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-widest text-slate-400">Account Status</p>
