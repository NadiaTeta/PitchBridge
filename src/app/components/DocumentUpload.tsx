...
export function DocumentUpload() {
  ...
  const handleUpload = (docType: 'selfie' | 'nida' | 'tin') => {
    // Simulate file upload
    setUploads({ ...uploads, [docType]: true });
  };

  const canSubmit = uploads.selfie && uploads.nida;
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            {!uploads.nida ? (
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl p-4 text-center text-green-700">
                <CheckCircle2 className="w-8 h-8 mx-auto mb-2" />
                <p>NIDA uploaded successfully</p>
              </div>
            )}
          </div>
