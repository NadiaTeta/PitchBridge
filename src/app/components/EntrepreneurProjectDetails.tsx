  ...
  if (!project) return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50">
      <div className="text-center px-6">
        <p className="text-slate-500 mb-4 font-medium">Project not found</p>
        <button onClick={() => navigate('/dashboard')} className="text-blue-600 font-bold">Return to Hub</button>
      </div>
    </div>
  );
